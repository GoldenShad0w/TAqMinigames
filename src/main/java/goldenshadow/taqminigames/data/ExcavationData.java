    ...
    public ExcavationData(Map map) {
        ...
        switch (map) {
            ...
            case DESERT -> {
                ...
                SPIKE_BOXES = new Location[][]{{new Location(Bukkit.getWorld("minigames2"), 10236.0, 11.5, 9080, 811, 90), new Location(Bukkit.getWorld("minigames2"), 10230.0, 11.0, 9091.0, 742, 90)}, {new Location(Bukkit.getWorld("minigames2"), 10240.0, 11.0, 9071.0, 1384, 89), new Location(Bukkit.getWorld("minigames2"), 10256.0, 11.5, 9092.0, 1588, 90)}, {new Location(Bukkit.getWorld("minigames2"), 10142.0, 8.5, 8997.0, 1917, 88), new Location(Bukkit.getWorld("minigames2"), 10145.0, 8.0, 9008.0, 2129, 90)}, {new Location(Bukkit.getWorld("minigames2"), 10236.0, 8.0, 9020.0, 4116, 90), new Location(Bukkit.getWorld("minigames2"), 10229.0, 8.0, 9021.0, 4037, 89)}};
                FLAMETHROWER_BOXES = new Location[][]{{new Location(Bukkit.getWorld("minigames2"), 10178.0, 13.5, 8926.0, 2391, 90), new Location(Bukkit.getWorld("minigames2"), 10179.0, 15.5, 8925.0, 2928, 90)}, {new Location(Bukkit.getWorld("minigames2"), 10180.0, 13.5, 8919.0, 3106, 90), new Location(Bukkit.getWorld("minigames2"), 10181.0, 15.5, 8918.0, 3285, 90)}, {new Location(Bukkit.getWorld("minigames2"), 10178.0, 13.5, 8915.0, 3467, 90), new Location(Bukkit.getWorld("minigames2"), 10179.0, 15.5, 8914.0, 3468, 90)}, {new Location(Bukkit.getWorld("minigames2"), 10229.0, 8.0, 9021.0), new Location(Bukkit.getWorld("minigames2"), 10230.0, 10.0, 9021.0, 4199, 90)}, {new Location(Bukkit.getWorld("minigames2"), 10229.0, 8.0, 9020.0, 4584, 90), new Location(Bukkit.getWorld("minigames2"), 10230.0, 10.0, 9019.0, 4525, 88)}, {new Location(Bukkit.getWorld("minigames2"), 10232.0, 8.0, 9020.0, 4678, 90), new Location(Bukkit.getWorld("minigames2"), 10233.0, 10.0, 9019.0, 4508, 89), new Location(Bukkit.getWorld("minigames2"), 10233.0, 8.0, 9021.0, 4550, 88), new Location(Bukkit.getWorld("minigames2"), 10232.0, 10.0, 9022.0, 4771, 90)}, {new Location(Bukkit.getWorld("minigames2"), 10235.0, 8.0, 9020.0, 5087, 90), new Location(Bukkit.getWorld("minigames2"), 10236.0, 10.0, 9019.0, 5220, 89)}, {new Location(Bukkit.getWorld("minigames2"), 10236.0, 8.0, 9021.0, 5470, 90), new Location(Bukkit.getWorld("minigames2"), 10235.0, 10.0, 9022.0, 5406, 85)}, {new Location(Bukkit.getWorld("minigames2"), 10183.0, 16.0, 9136.0, 5797, 89), new Location(Bukkit.getWorld("minigames2"), 10184.0, 16.0, 9140.0, 5756, 85)}, {new Location(Bukkit.getWorld("minigames2"), 10216.0, 15.0, 9133.0, 5933, 90), new Location(Bukkit.getWorld("minigames2"), 10217.0, 15.0, 9139.0, 6128, 90)}, {new Location(Bukkit.getWorld("minigames2"), 10220.0, 15.0, 9133.0, 5933, 90), new Location(Bukkit.getWorld("minigames2"), 10221.0, 15.0, 9139.0, 6128, 90)}, {new Location(Bukkit.getWorld("minigames2"), 10224.0, 15.0, 9133.0, 5933, 90), new Location(Bukkit.getWorld("minigames2"), 10225.0, 15.0, 9139.0, 6128, 90)}, {new Location(Bukkit.getWorld("minigames2"), 10228.0, 15.0, 9133.0, 5933, 90), new Location(Bukkit.getWorld("minigames2"), 10229.0, 15.0, 9139.0, 6128, 90)}};
